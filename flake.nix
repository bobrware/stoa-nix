{
  ...
  outputs = {
    ...
    sha256 = "4bd6d6467fb5f13d0089077658b9eddb76b894f7923df7e0e4259403107fec0b";
  in
...
export PATH="${pkgs.lib.makeBinPath [ pkgs.xdg-utils ]}:/run/wrappers/bin:/run/current-system/sw/bin:/usr/bin:/bin"
